...
\begin{titlepage}
    ...
    \begin{singlespace}
        ...
        Look Boss, No hands seeks to develop a new interaction method between a user and looking at enterprise data. Instead of sitting behind a computer screen typing and clicking around to get graphs, and charts. This project aims to remove the standard methods of input, in lieu of more novel methods of input such as, voice and virtual reality. With the stretch goals of tracking a user\'s interaction with the new experience via a wearable.
